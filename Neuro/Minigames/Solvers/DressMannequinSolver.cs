...
public class DressMannequinSolver : GeneralMinigameSolver<DressUpMinigame>
{
    public override IEnumerator CompleteMinigame(DressUpMinigame minigame, NormalPlayerTask task)
    {
        ...
        yield return InGameCursor.Instance.CoMoveTo(hat.transform.position + new Vector3(0f, 0.5f) , 0.75f);
        ...
        yield return InGameCursor.Instance.CoMoveTo(accessory, 0.75f);
        ...
        yield return InGameCursor.Instance.CoMoveTo(clothes.transform.position - new Vector3(0f, 0.5f), 0.75f);
